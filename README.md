...
const Mathiscool = {
    ...
    CreatedAt: "idk",
    Stars: 0,
    FavouriteThings: ["GitHub <3", "Discord", "VS Code", "A Potato PC", "Javascript"]
}; //I'm a Epic Object. KEK
```
<hr>
<div>
...
![Profile Views](https://komarev.com/ghpvc/?username=testbot-github&color=blueviolet)&nbsp;&nbsp;![Profile Followers](https://img.shields.io/badge/Followers-1-blueviolet)&nbsp;&nbsp;![Profile Following](https://img.shields.io/badge/Following-2-blueviolet)&nbsp;&nbsp;![Profile Stars](https://img.shields.io/badge/Stars-0-blueviolet)
